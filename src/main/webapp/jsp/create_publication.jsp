...
<div class="main_holder">
    <div class="news section" hidden>
        <div class="news_header">
            <div class="image_holder" id="main_image_holder">
                <img class="main_image changeable_img" id="main_image"
                     src="${pageContext.request.contextPath}/getFile.do?command=take_file&file_name=empty.png"
                     alt="картинка">
            </div>
            <div class="news_header_text">
                <textarea class="news_topic" id="real_topic" placeholder="Title of the topic"></textarea>
                <div class="bottom_line">
                    <div class="bottom_line_text">10 февраля 2021</div>
                    <div class="bottom_line_text">17:32</div>
                    <div class="bottom_line_text">MegaCat23</div>
                </div>
            </div>
        </div>
    ...
    <form method="POST" action="publ.do" style="display: none;" id="hidden_form">
        <input type="hidden" name="command" value="create_publication">
